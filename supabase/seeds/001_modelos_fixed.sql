...
insert into public.boiler_models (id, brand_id, name, slug, description, price_base, price_final, price_rounded, notes) values
  ('m0000000-0000-0000-0000-000000000001', (select id from brand),
  ...
  ('m0000000-0000-0000-0000-000000000002', (select id from brand),
  ...
  ('m0000000-0000-0000-0000-000000000003', (select id from brand),
  ...
  ('m0000000-0000-0000-0000-000000000004', (select id from brand),
  ...
  ('m0000000-0000-0000-0000-000000000005', (select id from brand),
  ...
  ('m0000000-0000-0000-0000-000000000006', (select id from brand),
  ...
  ('m0000000-0000-0000-0000-000000000007', (select id from brand),
    ...
    'Este presupuesto incluye la instalación de la caldera en la ubicación de la caldera preexistente.'),
  ('m0000000-0000-0000-0000-000000000008', (select id from brand),
    ...
    'Este presupuesto incluye la instalación de la caldera en la ubicación de la caldera preexistente.'),
  ('m0000000-0000-0000-0000-000000000009', (select id from brand),
    ...
    'Este presupuesto incluye la instalación de la caldera en la ubicación de la caldera preexistente.'),
  ('m0000000-0000-0000-0000-000000000010', (select id from brand),
    ...
    'Este presupuesto incluye la instalación de la caldera en la ubicación de la caldera preexistente.'),
  ('m0000000-0000-0000-0000-000000000011', (select id from brand),
  ...
  ('m0000000-0000-0000-0000-000000000012', (select id from brand),
...
declare
  ...
  model_id uuid;
begin
  foreach slug in array model_slugs loop
    select id into model_id from public.boiler_models where slug = slug;
    ...
    if slug not like 'saunier-themafast%' then
      insert into public.model_includes (model_id, description, sort_order)
...
insert into public.boiler_models (id, brand_id, name, slug, description, price_base, price_final, price_rounded, notes) values
  ('m0000000-0000-0000-0000-000000000020', (select id from brand),
    ...
    'Este presupuesto incluye la instalación de la caldera en la ubicación de la caldera preexistente.'),
  ('m0000000-0000-0000-0000-000000000021', (select id from brand),
    ...
    'Este presupuesto incluye la instalación de la caldera en la ubicación de la caldera preexistente.'),
  ('m0000000-0000-0000-0000-000000000022', (select id from brand),
    ...
    'Este presupuesto incluye la instalación de la caldera en la ubicación de la caldera preexistente.'),
  ('m0000000-0000-0000-0000-000000000023', (select id from brand),
    ...
    'Este presupuesto incluye la instalación de la caldera en la ubicación de la caldera preexistente.'),
  ('m0000000-0000-0000-0000-000000000024', (select id from brand),
    ...
    'Este presupuesto incluye la instalación de la caldera en la ubicación de la caldera preexistente.'),
  ('m0000000-0000-0000-0000-000000000025', (select id from brand),
    ...
    'Este presupuesto incluye la instalación de la caldera en la ubicación de la caldera preexistente.'),
  ('m0000000-0000-0000-0000-000000000026', (select id from brand),
  ...
  ('m0000000-0000-0000-0000-000000000027', (select id from brand),
...
values ('m0000000-0000-0000-0000-000000000030', (select id from brand),
...
insert into public.boiler_models (id, brand_id, name, slug, description, price_base, price_final, price_rounded) values
  ('m0000000-0000-0000-0000-000000000040', (select id from brand),
  ...
  ('m0000000-0000-0000-0000-000000000041', (select id from brand),
  ...
  ('m0000000-0000-0000-0000-000000000042', (select id from brand),
  ...
  ('m0000000-0000-0000-0000-000000000043', (select id from brand),
...
insert into public.boiler_models (id, brand_id, name, slug, description, price_base, price_final, price_rounded) values
  ('m0000000-0000-0000-0000-000000000050', (select id from brand),
  ...
  ('m0000000-0000-0000-0000-000000000051', (select id from brand),
    'Ariston Clas One wifi 30FFEU', 'ariston-clas-one-30',
    'Caldera de condensación Ariston Clas One wifi 30FFEU Gas Natural.',
    1750.00, 2117.50, 2118),
  ('m0000000-0000-0000-0000-000000000052', (select id from brand),
...
insert into public.boiler_models (id, brand_id, name, slug, description, price_base, price_final, price_rounded) values
  ('m0000000-0000-0000-0000-000000000070', (select id from brand),
    'Warmhaus Enerwa 33-40', 'warmhaus-enerwa-33-40',
    'Caldera de condensación Warmhaus Enerwa 33-40 Gas Natural.',
    1700.00, 2057.00, 2057),
  ('m0000000-0000-0000-0000-000000000071', (select id from brand),
